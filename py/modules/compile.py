...
def less():
    ...
    md5_file = append_md5(engine.path_join(engine.LOCAL_WWW_DIR, engine.BUILD_URL, 'style.css'), copy_zipped = True)
...
def js():
    ...
    md5_file = append_md5(engine.path_join(engine.LOCAL_WWW_DIR, engine.BUILD_URL, '/main.js'), copy_zipped = True)
